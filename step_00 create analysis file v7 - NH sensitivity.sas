...
NH sensitivity creates multiple definitions for NH stay that was requested 
...
libname inrand "&path\randpsas\";
libname lw "&path\LangaWeir";
...
if nh&N. = 0  then do;
	if &L.WHY0RWT = 2  then do;
		nh&N. = 1; * R interview in NH;
		nh_any&N. = 1;
		nh60&N. = 1;
		nh100&N. = 1;
		end;
	** set everyone to censored (.C) and then try to recover as many as possible;	
	else if &L.WHY0RWT in (1, 5, 6, 7) then do;
		nh&N. = .C; 
		nh60&N. = .C;
		nh100&N. = .C;
		nh_any&N. = .C;
...
if nh60&N. in (0, .C) then do;
**60d NH;
	if &L.N114 = 1 and (998>&L.N116>59) then nh60&N. = 1; *core interview days in NH;
		else if &L.N114 = 1 and &L.N116 = 998 and nh60&N. = .C then nh60&N. = 0;
		else if &L.N114 = 1 and &L.N116 le 59 and nh60&N. = .C then nh60&N. = 0;
		else if &L.N114 = 5 and nh60&N. = .C then nh60&N. = 0; 
	if &X.N114 = 1 and (998>&X.N116>59) then nh60&N. = 1; *exit interview days in NH;
		else if &X.N114 = 1 and &X.N116 = 998 and nh60&N. = .C then nh60&N. = 0;
		else if &X.N114 = 1 and &X.N116 le 59 and nh60&N. = .C then nh60&N. = 0;
		else if &X.N114 = 5 and nh60&N. = .C then nh60&N. = 0; 
	if &L.N114 = 1 and (98>&L.N117>=2) then nh60&N. = 1; *core intervie mo in NH;
		else if &L.N114 = 1 and &L.N117 = 98 and nh60&N. = .C then nh60&N. = 0;
		else if &L.N114 = 1 and &L.N117 < 2 and nh60&N. = .C then nh60&N. = 0;
	if &X.N114 = 1 and (98>&X.N117>=2) then nh60&N. = 1; *exit interview mo in NH;
		else if &X.N114 = 1 and &X.N117 = 98 and nh60&N. = .C then nh60&N. = 0;
		else if &X.N114 = 1 and &X.N117 < 2 and nh60&N. = .C then nh60&N. = 0;
	if &X.A124 = 2 then nh60&N. = 1; * died in NH;
end;

if nh100&N. in (0, .C) then do;
**100d NH;
	if &L.N114 = 1 and (998>&L.N116>99) then nh100&N. = 1; *core interview days in NH;
		else if &L.N114 = 1 and &L.N116 = 998 and nh100&N. = .C then nh100&N. = 0;
		else if &L.N114 = 1 and &L.N116 le 99 and nh100&N. = .C then nh100&N. = 0;
		else if &L.N114 = 5 and nh100&N. = .C then nh100&N. = 0; 
	if &X.N114 = 1 and (998>&X.N116>99) then nh100&N. = 1; *exit interview days in NH;
		else if &X.N114 = 1 and &X.N116 = 998 and nh100&N. = .C then nh100&N. = 0;
		else if &X.N114 = 1 and &X.N116 le 99 and nh100&N. = .C then nh100&N. = 0;
		else if &X.N114 = 5 and nh100&N. = .C then nh100&N. = 0; 
	if &L.N114 = 1 and (98>&L.N117>3) then nh100&N. = 1; *core intervie mo in NH;
		else if &L.N114 = 1 and &L.N117 = 98 and nh100&N. = .C then nh100&N. = 0;
		else if &L.N114 = 1 and &L.N117 <= 3 and nh100&N. = .C then nh100&N. = 0;
	if &X.N114 = 1 and (98>&X.N117>3) then nh100&N. = 1; *exit interview mo in NH;
		else if &X.N114 = 1 and &X.N117 = 98 and nh100&N. = .C then nh100&N. = 0;
		else if &X.N114 = 1 and &X.N117 <= 3 and nh100&N. = .C then nh100&N. = 0;
	if &X.A124 = 2 then nh100&N. = 1; * died in NH;
end;

if nh_any&N. in (0, .C) then do;
**any NH;
	if &L.N114 = 1 then nh_any&N. = 1; 
		else if &L.N114 = 5 and nh_any&N. = .C then nh_any&N. = 0; 
	if &X.N114 = 1 then nh_any&N. = 1; 
		else if &X.N114 = 5 and nh_any&N. = .C then nh_any&N. = 0; 
	if &X.A124 = 2 then nh_any&N. = 1; * died in NH;
end;
...
OUT_nursinghome60_&M. = nh60&N.;
OUT_nursinghome100_&M. = nh100&N.;
OUT_nursinghome_any_&M. = nh_any&N.;
...
* %healthshock(P,13,X,12); *-> this is an error
...
data long (keep=HHID PN HHIDPN HHRES INW AGE WHY0RWT PROXY WAVE
	...
	WEIGHTS 
	OUT_ADLhelp OUT_deceased OUT_nursinghome OUT_nursinghome60 OUT_nursinghome100 OUT_nursinghome_any
...
array aOUT_nursinghome60(7:13) OUT_nursinghome60_7-OUT_nursinghome60_13;
array aOUT_nursinghome100(7:13) OUT_nursinghome100_7-OUT_nursinghome100_13;
array aOUT_nursinghome_any(7:14) OUT_nursinghome_any_7-OUT_nursinghome_any_14;
array ahelper_nextwave(7:13) helper7-helper13;
...
do wave= 7 to 13;
	...
	OUT_nursinghome60=aOUT_nursinghome60[wave];
	OUT_nursinghome100=aOUT_nursinghome100[wave];
	OUT_nursinghome_any=aOUT_nursinghome_any[wave];
	helper_nextwave =ahelper_nextwave[wave];
...
data out.analytic_long_20200808_NHsensi; set work.long;
run;

data out.analytic_wide_20200808_NHsensi; set work.wide3;
run;
...
data out.long_20200808_NHsensi_nomiss;
set work.a1;
run;
